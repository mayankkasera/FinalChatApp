...
/**
 * Created by mayank on 7/1/18.
 */

public class CrezyChatapp extends Application {
    ...
    public void onCreate() {
       ...
       // FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child(s);
